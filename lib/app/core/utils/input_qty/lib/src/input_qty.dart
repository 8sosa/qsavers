  ...
  Widget _buildtextfield() => TextFormField(
        ...
        validator: (val) {
          if (val == null || val.isEmpty) {
            _valCtrl.text = '0'; // Set text to '0' if empty
            return null; // Return null to clear validation message
          } else if (val == '-') {
            _valCtrl.text = '0'; // Set text to '0' if '-' is entered
            return null; // Return null to clear validation message
          } else {
            try {
              ...
              if (value < 0) {
                _valCtrl.text = '0'; // Set text to '0' if negative value is entered
                return null; // Return null to clear validation message
              }
            } catch (e) {
              _valCtrl.text = '0'; // Set text to '0' if parsing fails
              return null; // Return null to clear validation message
            }
          }
          return null;
        ...
        inputFormatters: [
          ...
          TextInputFormatter.withFunction((oldValue, newValue) {
            // Remove leading zeros when user starts typing numbers
