class AvailableCouponDataModel {
  var sId;
  var name;
  bool? forHomepage;
  var code;
  ...
  AvailableCouponDataModel.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    name = json['name'];
    ...
    isCouponUsed = json['is_coupon_used'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_coupon_used'] = this.isCouponUsed;
    return data;
  }
}
