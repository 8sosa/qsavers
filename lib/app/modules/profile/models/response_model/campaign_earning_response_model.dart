class CampaignEarningResponseModel {
  var success;
  var message;
  Data? data;

  CampaignEarningResponseModel({this.success, this.message, this.data});

  CampaignEarningResponseModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.data, this.count, this.totalEarning, this.moneyAvilable});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    moneyAvilable = json['money_avilable'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['money_avilable'] = this.moneyAvilable;
    return data;
  }
}
class Datum {
  ...
  var isDelete;
  var isMoneyTransfer;
  var moneyTransferDate;
  var allOrdersDelivered;
  var priceMoneyAmount;
  var description;
  var updatedAt;
  var createdAt;
  var cancelledAt;
  ...
  Datum(
      {this.sId,
        ...
        this.moneyTransferDate,
        this.allOrdersDelivered,
  ...
  Datum.fromJson(Map<String, dynamic> json) {
    ...
    moneyTransferDate = json['money_transfer_date'];
    allOrdersDelivered = json['all_orders_delivered'];
    priceMoneyAmount = json['price_money_amount'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['money_transfer_date'] = this.moneyTransferDate;
    data['all_orders_delivered'] = this.allOrdersDelivered;
    data['price_money_amount'] = this.priceMoneyAmount;
...
class ProductId {
  ...
  ProductId({this.sId, this.name, this.prodctId});
