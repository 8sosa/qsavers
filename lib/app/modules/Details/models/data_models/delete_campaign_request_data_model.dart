class DeleteCampaignRequestDataModel {
  var campaignName;
  var createdBy;
  var quantity;
  var totalQuantity;
  ...
  var sId;
  var iV;
  CancelReasson? cancelReasson;

  DeleteCampaignRequestDataModel(
      {this.campaignName,
      this.createdBy,
      this.quantity,
      this.totalQuantity,
  ...
  DeleteCampaignRequestDataModel.fromJson(Map<String, dynamic> json) {
    ...
    sId = json['_id'];
    iV = json['__v'];
    cancelReasson = json['cancel_reasson'] != null
        ? new CancelReasson.fromJson(json['cancel_reasson'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['_id'] = this.sId;
    data['__v'] = this.iV;
    if (this.cancelReasson != null) {
      data['cancel_reasson'] = this.cancelReasson!.toJson();
    }
    return data;
  }
}
...
class CancelReasson {
  ...
  CancelReasson({this.cancellationReason, this.description});

  CancelReasson.fromJson(Map<String, dynamic> json) {
