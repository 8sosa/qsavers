class StartCampaignDataModel {
  ...
  StartCampaignDataModel.fromJson(Map<String, dynamic> json) {
...
class UserGroupListData {
  ...
  UserGroupListData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
