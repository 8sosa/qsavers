class ManageAddressData {
  int? totalCount;
  List<ManageAddressDataSubData>? data;

  ManageAddressData({this.totalCount, this.data});

  ManageAddressData.fromJson(Map<String, dynamic> json) {
    totalCount = json['total_count'];
    if (json['data'] != null) {
      data = <ManageAddressDataSubData>[];
      json['data'].forEach((v) {
        data!.add(new ManageAddressDataSubData.fromJson(v));
      });
    }
  }
...
class ManageAddressDataSubData {
  String? sId;
  Location? location;
  String? name;
  String? userId;
  ...
  ManageAddressDataSubData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
