class VendorSearchResponseModel {
  bool? success;
  var message;
  Data? data;

  VendorSearchResponseModel({this.success, this.message, this.data});

  VendorSearchResponseModel.fromJson(Map<String, dynamic> json) {
